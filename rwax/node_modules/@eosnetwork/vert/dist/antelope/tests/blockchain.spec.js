    ...
    describe('eosio.token', () => {
        ...
        it('create: negative_max_supply', async () => {
            try {
                ...
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('max-supply must be positive'));
            }
        });
        it('create: symbol_already_exists', async () => {
            ...
            try {
                ...
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('token with symbol already exists'));
            }
        });
        it('create: max_supply', async () => {
            ...
            try {
                ...
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('invalid supply'));
            }
        });
        ...
        it('issue', async () => {
            ...
            try {
                ...
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('quantity exceeds available supply'));
            }
            try {
                await eosioToken.actions.issue(['alice', '-1.000 TKN', 'hola']).send('alice@active');
            }
            catch (e) {
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('must issue positive quantity'));
            }
        ...
        it('transfer', async () => {
            ...
            try {
                ...
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('overdrawn balance'));
            }
            try {
                await eosioToken.actions.transfer(['alice', 'bob', '-1000 CERO', 'hola']).send('alice@active');
            }
            catch (e) {
                (0, chai_1.expect)(e.message).to.equal((0, errors_1.antelopeAssert)('must transfer positive quantity'));
            }
        });
    });
});
