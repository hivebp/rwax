          ...
          `);
            ...
            `);
                ...
                db_idx256_update: (iterator, _payer, data, data_len) => {
                    vert_1.log.debug(`db_idx256_update: Iterator ${iterator}`);
                    const payer = BigInt.asUintN(64, _payer);
                ...
                */
                ...
                eosio_assert: (test, msg) => {
                    ...
                    if (!test) {
                        throw new Error((0, errors_1.antelopeAssert)(this.memory.readString(msg)));
                    }
                },
                eosio_assert_message: (test, msg, msg_len) => {
                    // log.debug('eosio_assert_message');
                    if (!test) {
                        throw new Error((0, errors_1.antelopeAssertMessage)(this.memory.readString(msg, msg_len)));
                    }
                },
                eosio_assert_code: (test, code) => {
                    // log.debug('eosio_assert_code');
                    if (!test) {
                        throw new Error((0, errors_1.antelopeAssertMessage)((0, errors_1.antelopeAssertCode)(BigInt.asUintN(64, code))));
                    }
                },
                eosio_exit: (code) => {
